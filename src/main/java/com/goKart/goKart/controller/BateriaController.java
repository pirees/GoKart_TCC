...
public class BateriaController {
	...
	@PutMapping("kartodromo/listaBateria/{id}")
	public String atualizarBateria(@PathVariable("id") Long id, Bateria bateria){

		if(bateria.getVagasConfirmadas() == 0){
			return "kartodromo/listarBateria/{id}";
		}

		return "kartodromo/listarBateria";
	}

	@GetMapping("kartodromo/listaBateria/{id}")
	public String listarBateriaPorId(@PathVariable("id") Long id, Bateria bateria){
